...
#     products = Product.objects.filter(ctegory__slug=slug)
...
class ProductListView(ListView):
    ...
    def get_queryset(self):
        ...
        queryset = queryset.filter(ctegory__slug=category)
        return queryset
...
class ProductUpdateView(UpdateView):
    model = Product
    template_name = 'product/update_product_form.html'
